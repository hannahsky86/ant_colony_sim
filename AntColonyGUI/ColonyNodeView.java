...
public class ColonyNodeView extends JPanel
{
	...
	private void initComponents()
	{
		...
		// displays level of pheromone present
		pheromoneLabel = new JLabel("Pher:");
		pheromoneLabel.setFont(NODE_FONT);
		pheromoneLabel.setForeground(LABEL_COLOR);
		
		// displays level of pheromone present
		timeLabel = new JLabel("Day:");
		timeLabel.setFont(NODE_FONT);
	...
	private void layoutComponents()
	{
		...
		layout.putConstraint(SpringLayout.NORTH, timeLabel, 85, SpringLayout.NORTH, this);
	...
	{
		foragerLabel.setText("Forager: " + numForagers);
	}
	...
	{
		scoutLabel.setText("Scout: " + numScouts);
	}
	...
	{
		soldierLabel.setText("Soldier: " + numSoldiers);
	}
	...
	{
		balaLabel.setText("Bala: " + numBalas);
	}
	...
	public void setPheromoneLevel(int pheromone)
	{
		...
		pheromoneLabel.setText("Pher: " + pheromone);
